    ...
    return <div className={"home-page"}>
        {
            auth.isLoggedIn ? <Fragment>
                ...
                <nav className={"home-page_navigation"}>
                    {auth.hasPermissionOrAdmin(4001) ? <div className={"home-page_navigation_group"}>
                    ...
                    {auth.hasPermissionOrAdmin(3001) ? <div className={"home-page_navigation_group"}>
                        <NavLink to={"/nodes/view"}>/ сетевые узлы</NavLink>
                        <NavLink to={"/nodes/map"}>/ карта сети</NavLink>
                    </div> : <Fragment/>}
                    {auth.hasPermissionOrAdmin(5001) ? <div className={"home-page_navigation_group"}>
